...
namespace slam {
    namespace eval {
        namespace se3 {
             ...
             */
            class ComposeEvaluator : public Evaluable<slam::se3::Transformation> {
                ...
                public:
                    ...
                    using InType = slam::se3::Transformation;  ///< Input type: SE(3) transformation
                    using OutType = slam::se3::Transformation; ///< Output type: SE(3) transformation
